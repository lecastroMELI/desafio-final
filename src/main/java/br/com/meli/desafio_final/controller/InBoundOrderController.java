...
public class InBoundOrderController {
    ...
    @PostMapping("/{agentId}")
    public ResponseEntity<List<InBoundOrderDto>> createInBoundOrder(@PathVariable long agentId,
    ...
    /**
     * Nesse método estamos atualizando (atualizando um produto) de uma InBoundOrder
     * @param agentId
     * @param inBoundOrder
     */
    @PutMapping("/{agentId}")
    public ResponseEntity<List<InBoundOrderDto>> updateInBoundOrder(@PathVariable long agentId,
        @RequestBody InBoundOrder inBoundOrder) {
